...
JobItem = (function(_super) {
  ...
  JobItem.prototype.bindings = {
    ...
    ".startedAt": {
      ...
      visible: function() {
        return this.model.get('status') !== 'complete';
      },
      updateView: true,
      onGet: function() {
...
ReportResults = (function(_super) {
  ...
  ReportResults.prototype.defaultPollingInterval = 5000;
  ...
  ReportResults.prototype.poll = function() {
    ...
    return this.fetch({
      success: function() {
        ...
        if (_.find(_this.models, function(r) {
          return r.error != null;
        })) {
          return _this.trigger('error', 'JOB_ERROR');
        } else {
      ...
      error: function() {
        ...
        return _this.trigger('error', 'JOB_SUBMISSION');
      }
    });
  };
...
ReportTab = (function(_super) {
  ...
  ReportTab.prototype.initialize = function(model, options) {
    ...
    this.listenTo(this.reportResults, 'error', this.reportError);
    this.listenToOnce(this.reportResults, 'jobs', this.renderJobDetails);
    this.listenTo(this.reportResults, 'jobs', this.reportJobs);
  ...
  ReportTab.prototype.show = function() {
    this.$el.show();
    this.visible = true;
    if (!this.reportResults.models.length) {
  ...
  ReportTab.prototype.reportError = function(e) {
    if (e === 'JOB_ERROR') {
      return console.log('Error with specific job');
    } else {
      return console.log('Error requesting report results from the server');
    }
  };
...
},{"./enableLayerTogglers.coffee":2,"./jobItem.coffee":3,"./reportResults.coffee":4,"./utils.coffee":"d+CDld","api/templates":"fIqoFw","views/collectionView":1}],"api/templates":[function(require,module,exports){
...
},{"../templates/templates.js":15,"reportTab":"perKyw"}],11:[function(require,module,exports){
...
},{"../templates/templates.js":15,"reportTab":"perKyw"}],"reportTab":[function(require,module,exports){
...
MooringHabitatTab = (function(_super) {
  ...
  MooringHabitatTab.prototype.dependencies = ['HabitatsInMooring'];

  MooringHabitatTab.prototype.heading = "Habitats Impacted by Mooring Area";

  MooringHabitatTab.prototype.paramName = "HabitatsInMooring";
...
},{"../templates/templates.js":15,"./fishingValue.coffee":10,"./habitatTab.coffee":11,"./overviewTab.coffee":14}],14:[function(require,module,exports){
